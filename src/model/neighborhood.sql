...
--
-- Name: genders; Type: TABLE; Schema: public; Owner: robertrodes
--
...
ALTER TABLE public.genders OWNER TO robertrodes;

--
-- Name: genders_id_seq; Type: SEQUENCE; Schema: public; Owner: robertrodes
--
...
ALTER TABLE public.genders_id_seq OWNER TO robertrodes;

--
-- Name: genders_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: robertrodes
--
...
--
-- Name: genders id; Type: DEFAULT; Schema: public; Owner: robertrodes
--
...
--
-- Data for Name: genders; Type: TABLE DATA; Schema: public; Owner: robertrodes
--
...
--
-- Data for Name: neighborhoods; Type: TABLE DATA; Schema: public; Owner: robertrodes
--
...
--
-- Data for Name: neighborhoods_users; Type: TABLE DATA; Schema: public; Owner: robertrodes
--
...
--
-- Data for Name: requests; Type: TABLE DATA; Schema: public; Owner: robertrodes
--
...
--
-- Data for Name: responses; Type: TABLE DATA; Schema: public; Owner: robertrodes
--
...
--
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: robertrodes
--
...
--
-- Name: genders_id_seq; Type: SEQUENCE SET; Schema: public; Owner: robertrodes
--
...
--
-- Name: neighborhoods_id_seq; Type: SEQUENCE SET; Schema: public; Owner: robertrodes
--
...
--
-- Name: requests_id_seq; Type: SEQUENCE SET; Schema: public; Owner: robertrodes
--
...
--
-- Name: responses_id_seq; Type: SEQUENCE SET; Schema: public; Owner: robertrodes
--
...
--
-- Name: users_id_seq; Type: SEQUENCE SET; Schema: public; Owner: robertrodes
--
...
--
-- Name: genders genders_pkey; Type: CONSTRAINT; Schema: public; Owner: robertrodes
--
...
--
-- Name: users users_gender_fkey; Type: FK CONSTRAINT; Schema: public; Owner: robertrodes
--
