      ...
      <section>
        ...
        <div className="all-neighborhoods">
          <figure className="card">
            <img src={require('./images/palm-tree.jpeg')} alt='neighborhood'/>
            <figcaption>
              <span className="info">
                <h2>Palm Springs <span>(Admin)</span></h2>
          ...
          <figure className="card">
          <img src={require('./images/up-north.jpg')} alt='neighborhood'/>
            <figcaption>
              <span className="info">
                <h2>Up North <span>(Member)</span></h2>
                <p>You can join other neighborhoods!</p>
              </span>
              <button className="explore-neighborhood">Explore</button>
            </figcaption>
        ...
        <div className="all-active-requests">
          <div className="request-card">
            <img
              ...
              alt="active request in neighborhood app" />
          ...
          <div className="request-card">
            <img
              src="images/image.jpeg"
              alt="active requests on neighborhood app" />
      ...
      <section>
        ...
        <div className="all-responded-requests">
          <div className="responded-request-card">
            ...
            <img
              src="images/cat.jpg"
              alt="responded requests on neighborhood app" />
