 ...
 */
const createResponse = async (responseData: ResponseData, userId: number): Promise<Response> => {
 ...
 */
const isUserResponseCreator = async (responseId: number, userId: number): Promise<boolean> => {
 ...
 * @returns - Promise resolving to a boolean
 */
const isUserRequestCreator = async (responseId: number, userId: number): Promise<boolean> => {
  const response = await getResponseById(responseId);
 ...
 */
const hasUserDeleteRights = async (responseId: number, userId: number): Promise<boolean> => {
  const response = await getResponseById(responseId);
